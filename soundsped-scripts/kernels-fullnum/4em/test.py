...
fx=args.fx;rtol=args.rtol
print(f'Using fx={fx:.1e}, rtol={rtol:.1e} and neval={args.neval}')
...
g_c_int=interp1d(fullt,linsol[:,1]/linsol[:, 0],bounds_error=False,fill_value=(1-3/5*fx,1.))
