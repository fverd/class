...
kevList=np.logspace(np.log10(0.05),np.log10(10),30)
# kevList = [0.15]
...
if not args.nosave:
    outfile='/home/fverdian/class/soundspeed-scripts/kernels-fullnum/numerical-integrals/4diego-theta-z4/dT13EdSh-kJ'+str(kref).replace('.','p')+'-fx'+str(fx).replace('.','p')+'-N'+str(args.neval)+'.txt'
