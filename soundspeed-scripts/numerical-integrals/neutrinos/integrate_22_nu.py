...
# kevList=np.logspace(np.log10(0.05),np.log10(4),30)
...
if not args.nosave:
    outfile='/home/fverdian/class/soundspeed-scripts/numerical-integrals/neutrinos/P22-Mnu'+str(Mnu).replace('.','p')+'-N'+str(args.neval)+'-p'+str(p)+'.txt'
...
for kEval in kevList:
    integ = vegas.Integrator([[np.log(1.e-4), np.log(5.)], [0., 1.]],mpi=True, nproc=70)
    ...
    print(f'num {resdcdc22}, EdS {traindcdc22}')
